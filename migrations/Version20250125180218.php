 ...
 */
final class Version20250125180218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD team_id INT DEFAULT NULL, DROP team');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD team VARCHAR(30) DEFAULT NULL, DROP team_id');
    }
}
