...
final class TaskControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'task[title]' => 'Testing',
            'task[descriptionTask]' => 'Testing',
            'task[initDate]' => 'Testing',
            'task[finishDate]' => 'Testing',
            'task[flagTask]' => 'Testing',
            'task[user]' => 'Testing',
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDescriptionTask('My Title');
        $fixture->setInitDate('My Title');
        $fixture->setFinishDate('My Title');
        $fixture->setFlagTask('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setDescriptionTask('Value');
        $fixture->setInitDate('Value');
        $fixture->setFinishDate('Value');
        $fixture->setFlagTask('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'task[descriptionTask]' => 'Something New',
            'task[initDate]' => 'Something New',
            'task[finishDate]' => 'Something New',
            'task[flagTask]' => 'Something New',
            'task[user]' => 'Something New',
            'task[Project]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDescriptionTask());
        self::assertSame('Something New', $fixture[0]->getInitDate());
        self::assertSame('Something New', $fixture[0]->getFinishDate());
        self::assertSame('Something New', $fixture[0]->getFlagTask());
